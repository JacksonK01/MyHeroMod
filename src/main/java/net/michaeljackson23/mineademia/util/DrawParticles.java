...
public final class DrawParticles {
    ...
    public <T extends ParticleEffect> int spawnParticle(@NotNull T particleEffect, float x, float y, float z, int count, float deltaX, float deltaY, float deltaZ, float speed, boolean force) {
    ...
    public <T extends ParticleEffect> int spawnParticle(@NotNull T particleEffect, float x, float y, float z, int count, @NotNull Vec3d delta, float speed, boolean force) {
        return spawnParticle(particleEffect, x, y, z, count, (float) delta.x, (float) delta.y, (float) delta.z, speed, force);
    }

    public <T extends ParticleEffect> int spawnParticle(@NotNull T particleEffect, @NotNull Vec3d pos, int count, float deltaX, float deltaY, float deltaZ, float speed, boolean force) {
        return spawnParticle(particleEffect, (float) pos.x, (float) pos.y, (float) pos.z, count, deltaX, deltaY, deltaZ, speed, force);
    }

    public <T extends ParticleEffect> int spawnParticle(@NotNull T particleEffect, @NotNull Vec3d pos, int count, @NotNull Vec3d delta, float speed, boolean force) {
        return spawnParticle(particleEffect, (float) pos.x, (float) pos.y, (float) pos.z, count, (float) delta.x, (float) delta.y, (float) delta.z, speed, force);
    }
    ...
    public <T extends ParticleEffect> DrawParticles lerpBetween(@NotNull T particleEffect, int count, @NotNull Vec3d delta, float speed, boolean force, float time, float lerpDelta, float initialAlpha, @NotNull Vec3d... points) {
        ...
        while (alpha <= 1) {
            ...
            spawnParticle(particleEffect, point, count, delta, speed, force);
