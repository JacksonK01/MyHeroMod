...
public class CustomArmorModelRenderer {
    ...
    public static void register() {
        registerArmorRenderers("deku_gamma_costume", DekuGammaCostume::new, ArmorRegister.GAMMA_SUIT_HELMET, ArmorRegister.GAMMA_SUIT_CHESTPLATE, ArmorRegister.GAMMA_SUIT_LEGGINGS, ArmorRegister.GAMMA_SUIT_BOOTS);
    }
    ...
    private static void registerArmorRenderers(String nameOfModel, Function<ModelPart, AbstractArmorModel<LivingEntity>> modelConstructor, ItemConvertible... items) {
        ...
        EntityModelLayerRegistry.registerModelLayer(modelLayer, DekuGammaCostume::getTexturedModelData);
