...
public class DekuGammaCostume<T extends LivingEntity> extends AbstractArmorModel<T> implements ModelWithBoots {
	...
	public DekuGammaCostume(ModelPart root) {
        super(root);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData larm = modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(0, 16).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
				.uv(44, 46).cuboid(-1.0F, 1.0F, -2.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(34, 46).cuboid(-1.0F, 1.0F, 1.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r7 = larm.addChild("cube_r7", ModelPartBuilder.create().uv(49, 25).cuboid(-2.0F, 7.0F, 0.1F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(44, 6).cuboid(-2.0F, 1.0F, 0.1F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(50, 31).cuboid(-2.0F, 8.0F, -3.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(10, 46).cuboid(-2.0F, 1.0F, -3.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r8 = larm.addChild("cube_r8", ModelPartBuilder.create().uv(50, 27).cuboid(-3.0F, 8.0F, 1.2F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(50, 29).cuboid(-3.0F, 8.0F, -2.2F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		ModelPartData rarm = modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(16, 16).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
				.uv(24, 45).cuboid(-3.0F, 1.0F, -2.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(45, 0).cuboid(-3.0F, 1.0F, 1.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(44, 31).cuboid(-3.5F, 8.0F, -2.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r9 = rarm.addChild("cube_r9", ModelPartBuilder.create().uv(41, 41).cuboid(1.2F, 8.0F, -1.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
				.uv(44, 16).cuboid(-2.2F, 8.0F, -1.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
				.uv(50, 33).cuboid(-2.0F, 7.0F, -1.1F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(44, 11).cuboid(-2.0F, 1.0F, -1.1F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(44, 36).cuboid(-2.0F, 1.0F, 2.3F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		ModelPartData cube_r10 = lboot.addChild("cube_r10", ModelPartBuilder.create().uv(0, 44).cuboid(-2.0F, 4.0F, -2.5F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		ModelPartData cube_r11 = rboot.addChild("cube_r11", ModelPartBuilder.create().uv(25, 40).cuboid(-2.0F, 4.0F, 1.5F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
