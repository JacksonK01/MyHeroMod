...
public class EnginesModel<T extends LivingEntity> extends BipedEntityModel<T> implements QuirkModelHelper {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData left_engines_fire = modelPartData.addChild("left_engines_fire", ModelPartBuilder.create(), ModelTransform.of(2.0F, 12.0F, 0.0F, 0.0F, 0.0436F, 0.0F));
        ...
        ModelPartData fire10B_r1 = left_engines_fire.addChild("fire10B_r1", ModelPartBuilder.create().uv(-1, 51).cuboid(-4.2F, 2.8586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.4577F, -0.1586F, 0.8935F, 0.0774F, -0.0403F, -0.7854F));
        ...
        ModelPartData fire9B_r1 = left_engines_fire.addChild("fire9B_r1", ModelPartBuilder.create().uv(-1, 51).cuboid(-6.4F, 4.8F, 3.5F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
                .uv(-1, 51).cuboid(-5.2F, 3.8F, 3.5F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
                .uv(0, 51).cuboid(-4.2F, 2.7F, 3.5F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0774F, -0.0403F, -0.7854F));

        ModelPartData fire9A_r1 = left_engines_fire.addChild("fire9A_r1", ModelPartBuilder.create().uv(-1, 51).cuboid(4.1185F, 6.0F, 3.6258F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
                .uv(-1, 51).cuboid(3.1185F, 4.8264F, 3.6258F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData right_engines_fire = modelPartData.addChild("right_engines_fire", ModelPartBuilder.create(), ModelTransform.of(-2.0F, 12.0F, 0.0F, 0.0F, 0.0436F, 0.0F));

        ModelPartData fire6A_r1 = right_engines_fire.addChild("fire6A_r1", ModelPartBuilder.create().uv(0, 51).cuboid(-4.2577F, 2.9586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, 2.8414F, 0.9005F, 0.0774F, -0.0403F, -0.7854F));

        ModelPartData fire6A_r2 = right_engines_fire.addChild("fire6A_r2", ModelPartBuilder.create().uv(0, 51).cuboid(2.3423F, 3.9586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, 2.8414F, 0.9005F, -0.0175F, -0.0349F, 0.7854F));

        ModelPartData fire5B_r1 = right_engines_fire.addChild("fire5B_r1", ModelPartBuilder.create().uv(0, 51).cuboid(-3.8577F, 2.6586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, 1.8414F, 0.9005F, 0.0774F, -0.0403F, -0.7854F));

        ModelPartData fire5A_r1 = right_engines_fire.addChild("fire5A_r1", ModelPartBuilder.create().uv(0, 51).cuboid(1.9423F, 3.3586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, 1.8414F, 0.9005F, -0.0175F, -0.0349F, 0.7854F));

        ModelPartData fire4B_r1 = right_engines_fire.addChild("fire4B_r1", ModelPartBuilder.create().uv(0, 51).cuboid(-4.2F, 2.8586F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, -0.1586F, 0.9005F, 0.0774F, -0.0403F, -0.7854F));

        ModelPartData fire4A_r1 = right_engines_fire.addChild("fire4A_r1", ModelPartBuilder.create().uv(0, 51).cuboid(2.2423F, 3.8264F, 2.6065F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.6796F, -0.1586F, 0.9005F, -0.0175F, -0.0349F, 0.7854F));
        ...
        ModelPartData fire3B_r1 = right_engines_fire.addChild("fire3B_r1", ModelPartBuilder.create().uv(0, 51).cuboid(-6.4F, 4.8F, 3.5F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
                ...
                .uv(0, 51).cuboid(-4.2F, 2.7F, 3.5F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.2219F, 0.0F, 0.0071F, 0.0774F, -0.0403F, -0.7854F));
        ...
        ModelPartData fire3A_r1 = right_engines_fire.addChild("fire3A_r1", ModelPartBuilder.create().uv(0, 51).cuboid(4.1185F, 6.0F, 3.6258F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F))
                ...
                .uv(0, 51).cuboid(2.1185F, 3.8264F, 3.6258F, 1.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.2219F, 0.0F, 0.0071F, -0.0175F, -0.0349F, 0.7854F));
    ...
    public void copyModelState(ArmPose leftArmPose, ArmPose rightArmPose, ModelPart head, ModelPart hat, ModelPart body, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.left_engines.copyTransform(leftLeg);
