...
public class ModelData {
    ...
    private final Function<ModelPart, BipedEntityModel<LivingEntity>> modelConstructor;

    public ModelData(String modelName, String texture, Function<ModelPart, BipedEntityModel<LivingEntity>> constructor, EntityModelLayerRegistry.TexturedModelDataProvider texturedModelData) {
